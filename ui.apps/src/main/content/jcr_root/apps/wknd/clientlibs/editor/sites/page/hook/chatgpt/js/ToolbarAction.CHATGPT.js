(function ($, channel, window, undefined) {
    ...
    //     return editable && editable.type === "wknd/components/text";
    //   },
    //   
    isNonMulti: true,
    });
  ...
  function showDialog() {
    ...
    var dialog = new Coral.Dialog().set({
      ...
      content: {
        innerHTML: '<form class="coral-Form coral-Form--vertical"><section class="coral-Form-fieldset"><div class="coral-Form-fieldwrapper"><textarea is="coral-textarea" class="coral-Form-field" placeholder="Enter your prompt" id="textarea1"  name="name"></textarea></div><div class="coral-Form-fieldwrapper"> <textarea is="coral-textarea" rows="10" cols="30" class="coral-Form-field" placeholder="Result will be displayed here" id="textarea2"  name="name"></textarea></div></section></form>'
      },
      footer: {
